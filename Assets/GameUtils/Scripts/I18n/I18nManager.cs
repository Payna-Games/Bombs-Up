...
namespace YsoCorp {
    namespace GameUtils {
        ...
        public class I18nManager : BaseManager {
            ...
            private void Awake() {
                this.ycManager.i18nManager = this;
            }
            ...
            public Sprite GetCurrentStrite() {
                return this.i18NResourcesManager.GetSprite(this.GetLanguage());
            }
            ...
            public void NextLanguages() {
                ...
                this.SetLanguage(keys[(Array.IndexOf(keys, this.GetLanguage()) + 1) % keys.Length]);
